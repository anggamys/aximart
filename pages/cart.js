...
function CartScreen() {
  ...
  const updateCartHandler = async (item, qty) => {
    ...
    if (data.countInStock < quantity) {
      return toast.error('Maaf, stok produk sedang kosong');
    }
          ...
          <div className="overflow-x-auto md:col-span-3">
            <table className="min-w-full ">
              <thead className="border-b">
                <tr>
                  <th className="p-5 text-left">Barng</th>
            ...
            <ul>
              <li>
                <div className="pb-3 text-xl">
                  Jumlah total ({cartItems.reduce((a, c) => a + c.quantity, 0)}) : Rp.{cartItems.reduce((a, c) => a + c.quantity * c.price, 0)}
                </div>
              </li>
              <li>
